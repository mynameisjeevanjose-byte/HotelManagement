...
<head>
    ...
    <style>
        ...
        .pay-form button {
            padding: 10px 20px;
            background-color: #5cb85c; /* Green for pay */
            color: white;
            border: none;
            border-radius: 5px;
            font-size: 16px;
    ...
    <main class="main-content">
        <div class="basic_box">
            ...
            <table>
                ...
                <?php
                    // --- PHP Logic is Unchanged as Requested ---
                    $conn = new mysqli("localhost","root","", "hotel_db"); // Assuming hotel_db, was iwp in original
                    if($conn->connect_error)
                    {
                        die("Connection failed: ".$conn->connect_error);
                    }
        ...
        <div class="basic_box">
            ...
            <form action="payment.php" method="post" class="pay-form">
