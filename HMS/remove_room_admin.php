...
<head>
    ...
    <style>
        ...
        /* Form Styling */
        .remove-room-form .form-group {
            display: flex;
            align-items: center;
            margin-bottom: 15px;
            font-size: 18px;
        }
        .remove-room-form label {
            flex-basis: 40%;
            text-align: left;
        }
        .remove-room-form select, .remove-room-form input {
            flex-grow: 1;
            padding: 10px;
            font-size: 16px;
        ...
        .remove-room-form .btn {
            ...
            background-color: #d9534f; /* Red for remove/delete actions */
        }
        .remove-room-form .btn:hover {
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="basic_box">
            <h2>Remove Rooms</h2>
            <form action="admin_room_removed.php" method="post" class="remove-room-form">
                ...
                <div class="form-group">
                    <label for="noofrooms">Number of rooms to remove:</label>
                    <input type="number" min="1" name="noofrooms" id="noofrooms" required>
                </div>
                <button type="submit" class="btn">Remove Rooms</button>
            </form>
        </div>
    </main>
